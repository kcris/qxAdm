...
#include "presentation/qtgui/TablePrintDialog.h"
...
void TablePrintDialog::setupPage()
{
  ...
  double div = (double)(rowCount) / lines;
...
void TablePrintDialog::paintPage(int pagenum)
{
  ...
  if (headerSize > 0)
  {
    ...
    double xpos=(pageScene.width()/2.0)-(titleWidth/2.0);
    double ypos=(headerSize/2.0)-(titleFmt->height()/2.0);
